...
@SpringBootTest(properties = {
        ...
        "spring.datasource.url=jdbc:h2:mem:ctbackfillctrldisabled;MODE=PostgreSQL;DATABASE_TO_LOWER=TRUE",
        "spring.jpa.hibernate.ddl-auto=create-drop",
        "app.content-type-backfill.enabled=false"
})
class ContentTypeBackfillControllerDisabledTest {
    ...
    void endpointBeanIsNotCreatedWhenDisabled() {
        assertTrue(applicationContext.getBeansOfType(ContentTypeBackfillController.class).isEmpty());
    }
}
